    ...
    <div id="about-container" className="relative p-4 mb-4">
      ...
      <div className="relative justify-center items-center">
        <p className="font-medium text-base text-center mt-20  text-bluePText">
          ...
          <br /> Here You Get All The Amenities Like Community Hall, Gardens, Playground, Etc But Most Importantly Our Site Has An Attached Petrol Pump And An Attached Temple Named "Balaji Devsthal Mandir".
        </p>
        <p className="font-medium text-base text-center mt-20  text-bluePText">
